...
from (
  values
    ...
    ('enem-inicio-rapido', null, 4, 'resource', 'ENEM 2023 caderno azul', 'PDF oficial para pratica.', 'https://download.inep.gov.br/educacao_basica/enem/provas/2023/1_dia_caderno_1_azul_aplicacao_regular.pdf', 40),
