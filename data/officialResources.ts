...
export const OFFICIAL_RESOURCES: OfficialResource[] = [
  {
    ...
    title: 'ENEM 2023 - Caderno Azul (1o dia)',
    description: 'PDF oficial direto do INEP para praticar.',
    url: 'https://download.inep.gov.br/educacao_basica/enem/provas/2023/1_dia_caderno_1_azul_aplicacao_regular.pdf',
    exam: 'ENEM',
    trackColor: '#F97316',
    minutes: 40,
  },
